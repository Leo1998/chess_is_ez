...
def create_model():
    ...
    model.add(Conv2D(5, kernel_size=(3,3), data_format='channels_first', padding='same', input_shape=(5,8,8)))
    model.add(BatchNormalization())
    model.add(LeakyReLU(alpha=lReLUAlpha))
    model.add(Conv2D(16, kernel_size=(3,3), data_format='channels_first', padding='same'))
    model.add(BatchNormalization())
    model.add(LeakyReLU(alpha=lReLUAlpha))
    model.add(Conv2D(32, kernel_size=(3,3), data_format='channels_first', padding='same'))
    model.add(BatchNormalization())
    model.add(LeakyReLU(alpha=lReLUAlpha))
    ...
    model.add(BatchNormalization())
    model.add(LeakyReLU(alpha=lReLUAlpha))
    model.add(Conv2D(64, kernel_size=(3,3), data_format='channels_first', strides=(2,2)))
    model.add(BatchNormalization())
    model.add(LeakyReLU(alpha=lReLUAlpha))

    model.add(Conv2D(64, kernel_size=(2,2), data_format='channels_first', padding='same'))
    model.add(BatchNormalization())
    model.add(LeakyReLU(alpha=lReLUAlpha))
    model.add(Conv2D(64, kernel_size=(2,2), data_format='channels_first', padding='same'))
    model.add(BatchNormalization())
    model.add(LeakyReLU(alpha=lReLUAlpha))
    model.add(Conv2D(128, kernel_size=(2,2), data_format='channels_first', strides=(2,2)))
    model.add(BatchNormalization())
    model.add(LeakyReLU(alpha=lReLUAlpha))

    model.add(Conv2D(128, kernel_size=(1,1), data_format='channels_first'))
    model.add(BatchNormalization())
    model.add(LeakyReLU(alpha=lReLUAlpha))
    model.add(Conv2D(128, kernel_size=(1,1), data_format='channels_first'))
    model.add(BatchNormalization())
